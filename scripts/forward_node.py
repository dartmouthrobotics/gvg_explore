...
class Forward(object):
    def __init__(self):
        ...
        self.cmd_vel_pub = rospy.Publisher('cmd_vel'.format(robot_name), Twist, queue_size=1000)
        self.reset_odom_pub = rospy.Publisher('reset_odom'.format(robot_name), Twist, queue_size=1000)
        self.jointstate_pub = rospy.Publisher('joint_states'.format(robot_name), JointState, queue_size=1000)
        self.battery_pub = rospy.Publisher('battery'.format(robot_name), BatteryState, queue_size=1000)
